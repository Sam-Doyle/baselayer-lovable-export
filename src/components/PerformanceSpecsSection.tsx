        ...
        <section id="specs" ref={sectionRef} className="relative bg-[#F4F4F0] py-24 border-t border-[#1E201E]/10 overflow-hidden">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12">
                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 mb-24">
                    ...
                    >
                        <div className="inline-block border border-[#F95D1A] bg-[#F95D1A]/10 px-3 py-1 mb-6 self-start rounded-none">
                        ...
                        <button
                            ...
                            className="self-start px-8 py-5 border border-[#1E201E]/20 text-[#1E201E] font-heading font-black tracking-widest text-[13px] md:text-[14px] uppercase hover:bg-[#F95D1A] hover:text-[#F4F4F0] hover:border-[#F95D1A] transition-all rounded-none"
                        >
                            VIEW FORMULATION
                        </button>
                    </div>
                    ...
                    >
                        {specs.map((spec, i) => (
                            <div
                                key={i}
                                className="aspect-square flex flex-col justify-center items-center gap-2 border border-[#1E201E]/10 bg-[#1E201E]/5 backdrop-blur-sm p-4 hover:border-[#F95D1A]/50 hover:bg-[#F95D1A]/5 transition-colors group rounded-none"
                            >
                                <spec.icon className="w-6 h-6 text-[#1E201E]/60 group-hover:text-[#F95D1A] transition-colors" />
                                <span className="font-heading text-[10px] md:text-[11px] uppercase tracking-wider text-center text-[#1E201E]/70 font-bold group-hover:text-[#F95D1A] transition-colors">
                                    {spec.label}
                                </span>
                            </div>
                        ))}
