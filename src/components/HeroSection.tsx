      ...
      <div className="absolute inset-0 z-0 bg-[#1A2F4C]">
        <picture>
          ...
          <img
            ...
            loading="eager"
            decoding="async"
            className="absolute inset-0 w-full h-full object-cover object-[60%_center] md:object-[65%_center] lg:object-[center_right]"
          />
        </picture>
        {/* Gradient overlays to ensure text readability */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(26,47,76,0.85)_0%,rgba(26,47,76,0.5)_45%,transparent_65%)] md:bg-[linear-gradient(to_right,rgba(26,47,76,0.75)_0%,rgba(26,47,76,0.4)_35%,transparent_55%)]"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 md:px-12 pt-28 md:pt-20">
        <div className="max-w-[500px]">
          ...
          <div className="animate-fade-in-up flex items-center gap-3 mb-6">
            ...
            <span className="font-heading text-[10px] md:text-[11px] uppercase tracking-[0.2em] font-bold text-white/80">
              BUILT IN COLORADO FOR HARSH ELEMENTS
            </span>
          </div>

          {/* Primary Headline */}
          <h1 className="animate-fade-in-up font-heading text-5xl sm:text-6xl md:text-[84px] font-black tracking-tighter text-white uppercase leading-[0.85] mb-6">
            ONE CREAM.<br />
            15 SECONDS.<br />
            DONE.
          </h1>
          ...
          <div
            className="mt-8 mb-8 animate-fade-in-up flex items-center justify-between sm:justify-start gap-4 sm:gap-10 text-left border-t border-white/20 pt-6"
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="font-body text-[9px] text-white/80 font-bold uppercase tracking-[0.1em]">
                ONE STEP
              </span>
            </div>

            {/* Badge 2 */}
            <div className="flex flex-col gap-2 border-l border-white/20 pl-4 sm:pl-10">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="square" className="text-white">
