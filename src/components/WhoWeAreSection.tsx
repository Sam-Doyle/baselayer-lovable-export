...
const WhoWeAreSection = () => {
  ...
  return (
    <section id="who-we-are" ref={sectionRef} className="relative overflow-hidden">
      ...
      >
        <span className="font-body text-[11px] tracking-[0.3em] text-white/60 uppercase">
          Why we made it
        </span>
        ...
        <p className="font-body text-[15px] text-white/70 leading-relaxed mb-8">
          We made Base Layer in Breckenridge after getting tired of choosing between overpriced skincare systems and drugstore moisturizers that felt like oil. We spent two years making one formula that works fast, feels invisible, and fits into real life.
        </p>
        <Button
          variant="hero"
          size="lg"
