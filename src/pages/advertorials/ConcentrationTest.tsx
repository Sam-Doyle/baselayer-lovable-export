...
const ConcentrationTest = () => {
  ...
  useEffect(() => {
    ...
    trackEvent('advertorial_view', { page: 'concentration_test', type: 'advertorial', angle: 'concentration_transparency' });
    ...
    <div className="bg-white min-h-screen font-body text-[#111111] selection:bg-brand-accent selection:text-white pb-28 md:pb-24">
      ...
      <main className="max-w-[700px] mx-auto px-5 sm:px-6 py-10 md:py-14">
        ...
        <article className="prose prose-lg max-w-none text-gray-900 leading-[1.7] font-body">
          ...
          <p className="mb-8">
            One bottle is 50 ml and lasts about six weeks used morning and night. {FREE_SHIPPING_TERMS}{" "}<Link to={SHIPPING_POLICY_PATH} className="underline underline-offset-2">Shipping terms</Link>.
          </p>
